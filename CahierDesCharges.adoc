...
|Android version 11. Le _front-end_ mobile devra fonctionner sur les tablettes fournies par l'IUT.
|===
...
| Le projet CYMDroid doit être testable sur un système Android déployé dans une machine virtuelle. 

|DEV004
| Projet CheckYourMood "virtualisé"
| Le projet CheckYourMood V2 doit être testable sur un système LAMPfootnote:[Linux Apache MySQL PhP] déployé dans une machine virtuelle.
|===
